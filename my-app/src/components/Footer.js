  ...
  <footer className="py-5">
    ...
    <div className="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
      ...
      <ul className="list-unstyled d-flex">
        <li className="ms-3"><Link className="link-body-emphasis" href="#">
        <i class="fa-brands fa-facebook fa-beat-fade fs-2 text-primary"></i>
            </Link></li>
        <li className="ms-3"><Link className="link-body-emphasis" href="#">
        <i class="fa-brands fa-square-instagram fa-shake fs-2 text-danger"></i>
            </Link></li>
        <li className="ms-3"><Link className="link-body-emphasis" href="#">
        <i class="fa-brands fa-linkedin fa-beat fs-2 text-info"></i>
            </Link></li>
      </ul>
    </div>
  </footer>
